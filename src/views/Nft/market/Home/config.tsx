import { LinkExternal } from '@metaswap/uikit'
  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on MetaSwap.'),
      ],
    },
    {
      ...
      description: [
        t(
          'Soon! The current NFT Market is a basic version (phase 1), with early access to trading MetaSwap NFTs only.',
        ),
    ...
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.ecidade.org.br/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by MetaSwap from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
